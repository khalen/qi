...
void
QiOgl_BitmapToTexture(GLuint tex, const Bitmap* bitmap)
{
...
void
QiOgl_BlitBufferToScreen(const Bitmap* bitmap)
{
	QiOgl_InitBlitBufferState();
            ...
            else
            {
                ...
                if (clipRect.x < fbWidth && clipRect.y < fbHeight && clipRect.z >= 0.0f && clipRect.w >= 0.0f)
                {
                   ...
                   glDrawElements(GL_TRIANGLES, (GLsizei)cmd->ElemCount,
								  GL_UNSIGNED_SHORT, (void*)(intptr_t)(cmd->IdxOffset * sizeof(ImDrawIdx)));
                   CheckGL();
                }
            }
        }
